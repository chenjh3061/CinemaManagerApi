...
public class SysUser implements Serializable {
    ...
    public SysUser(Long userId, String userName, String password,
                   String salt, String email, String phoneNumber, Boolean sex,
                   String userPicture, Long roleId, String birthday, String autograph,
                   SysRole sysRole, Integer userIdentity) {
        this.userId = userId;
