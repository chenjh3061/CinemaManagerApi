...
import com.cinema.cm.common.constant.MovieRankingList;
import com.cinema.cm.common.response.ResponseResult;
import com.cinema.cm.domain.SysMovie;
import com.cinema.cm.domain.vo.SysMovieVo;
...
public class SysMovieController extends BaseController {
    ...
    private class MovieAudience {
        Long audience;
        public MovieAudience(Long audience) {
    ...
    @GetMapping("movieAudience/{id}")
    public ResponseResult findMovieAudience(@PathVariable Long id) {
        Long aud = sysMovieService.findMovieAudience(id);
        MovieAudience movieAudience = new MovieAudience(aud);
        return getResult(movieAudience);
    }
